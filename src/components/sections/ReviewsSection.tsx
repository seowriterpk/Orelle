...
export function ReviewsSection() {
  ...
  return (
    <section className="py-24 bg-[#0B0B0A] overflow-hidden border-t border-[#1A1A1A]">
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        >
          {reviews.map((review) => (
            <div 
              key={review.id} 
              className="flex-none w-[320px] md:w-[380px] bg-[#111] border border-[#222] p-8 rounded-sm snap-center md:snap-start flex flex-col"
            >
              ...
              <p className="text-[#CCC] text-sm leading-relaxed flex-grow line-clamp-4">"{review.text}"</p>
            </div>
          ))}
        </div>
